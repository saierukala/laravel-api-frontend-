...
/**
* @see \App\Http\Controllers\GalleryController::uploadImages
 * @see app/Http/Controllers/GalleryController.php:89
 * @route '/gallery/{folder}/images'
 */
export const uploadImages = (args: { folder: number | { id: number } } | [folder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/gallery/{folder}/images'
 */
uploadImages.url = (args: { folder: number | { id: number } } | [folder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { folder: args }
    }
 ...
 * @route '/gallery/{folder}/images'
 */
uploadImages.post = (args: { folder: number | { id: number } } | [folder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: uploadImages.url(args, options),
    method: 'post',
})
 ...
 * @route '/gallery/{folder}/images'
 */
    const uploadImagesForm = (args: { folder: number | { id: number } } | [folder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/gallery/{folder}/images'
 */
        uploadImagesForm.post = (args: { folder: number | { id: number } } | [folder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: uploadImages.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\GalleryController::destroyImage
 * @see app/Http/Controllers/GalleryController.php:127
 * @route '/gallery/{folder}/images/{image}'
 */
export const destroyImage = (args: { folder: number | { id: number }, image: number | { id: number } } | [folder: number | { id: number }, image: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/gallery/{folder}/images/{image}'
 */
destroyImage.url = (args: { folder: number | { id: number }, image: number | { id: number } } | [folder: number | { id: number }, image: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    folder: args[0],
                    image: args[1],
 ...
 * @route '/gallery/{folder}/images/{image}'
 */
destroyImage.delete = (args: { folder: number | { id: number }, image: number | { id: number } } | [folder: number | { id: number }, image: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyImage.url(args, options),
    method: 'delete',
})
 ...
 * @route '/gallery/{folder}/images/{image}'
 */
    const destroyImageForm = (args: { folder: number | { id: number }, image: number | { id: number } } | [folder: number | { id: number }, image: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/gallery/{folder}/images/{image}'
 */
        destroyImageForm.delete = (args: { folder: number | { id: number }, image: number | { id: number } } | [folder: number | { id: number }, image: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroyImage.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const GalleryController = { index, create, store, show, edit, update, destroy, uploadImages, destroyImage }
